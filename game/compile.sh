...
if [ $? -eq 0 ]; then
    ...
    echo "📋 Páginas: 8 (4 hojas con caras y traseras + 2 hojas de tokens)"
    echo ""
    ...
    echo "   - Página 7: Tokens (1 Leader + 1 Trust Indicator + 5 Team Blue + 6 Green + 6 Red)"
    echo "   - Página 8: Tokens traseros (copia de página 7)"
    echo ""
    echo "🖨️  Para imprimir:"
    echo "   - Abrir cards.pdf"
    echo "   - Configurar impresión por ambas caras"
    echo "   - Imprimir todo el documento (8 páginas)"
    echo ""
