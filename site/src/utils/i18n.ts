...
export const translations = {
  es: {
    ...
    game: {
      ...
      create_new_game: "Nueva Partida",
      create_new_game_desc: "Crea una nueva partida e invita a otros jugadores",
      create_game: "Crear Partida",
      webrtc_setup: "Configuración WebRTC",
      game_code: "Código de Partida",
      game_code_desc: "Comparte este código con el otro jugador para que pueda unirse",
      copy: "Copiar",
      copy_and_share: "Copia y Comparte",
      copy_desc: "Copia esta información y compártela con el creador de la partida",
      copy_placeholder: "La información para copiar aparecerá aquí...",
      paste_and_process: "Pega y Procesa",
      paste_desc: "Pega esta información del otro jugador y procesa la conexión",
      paste_placeholder: "Pega aquí la información del otro jugador...",
      paste: "Pegar",
      process: "Procesar",
      waiting_response: "Esperando respuesta del jugador...",
      connection_status: "Estado de Conexión",
      disconnected: "Desconectado",
      add_new_player: "Añadir Nuevo Jugador",
      ...
      player_registration_desc2: "Añade los nombres de los jugadores uno por uno. Luego podrás conectar con cada uno.",
      ...
      game_variables: "Variables de la Partida",
      leader: "Líder:",
      not_assigned: "Sin asignar",
      your_character: "Tu Carácter:",
      upto: "UpTO:",
      decrease: "Bajar",
      increase: "Subir",
      map: "Mapa:",
    ...
    game: {
      ...
      create_new_game_desc: "Create a new game and share the code with other players",
      create_game: "Create Game",
      webrtc_setup: "WebRTC Setup",
      game_code: "Game Code",
      game_code_desc: "Share this code with the other player so they can join",
      copy: "Copy",
      copy_and_share: "Copy and Share",
      copy_desc: "Copy this information and share it with the game creator",
      copy_placeholder: "Information to copy will appear here...",
      paste_and_process: "Paste and Process",
      paste_desc: "Paste this information from the other player and process the connection",
      paste_placeholder: "Paste the other player information here...",
      paste: "Paste",
      process: "Process",
      waiting_response: "Waiting for player response...",
      ...
      player_registration_desc2: "Add player names one by one. Then you can connect with each one.",
